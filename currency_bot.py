        ...
        try:
            ...
            if current_rate:
                ...
                if current_rate < threshold:
                    self.logger.info(
                        f"⚠️  Rate {current_rate} is below threshold {threshold}!"
                    )
                    ...
                    self.logger.info(
                        f"✅ Rate {current_rate} is above threshold {threshold}"
                    )
            else:
            ...
            while True:
                try:
                    ...
                    if current_rate:
                        ...
                        notification_sent = self.notifications.send_notifications(
                            rate_data
                        )
                    ...
                    self.logger.info(
                        f"⏳ Waiting {interval} minutes before next check..."
                    )
