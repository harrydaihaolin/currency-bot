...
class BaseNotificationManager(ABC):
    ...
    def _setup_logger(self) -> logging.Logger:
        ...
        logger = logging.getLogger(f"{self.config.currency_pair.lower().replace('-', '_')}_notifications")
    ...
    def send_notifications(self, rate_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if should_send_alert:
                ...
                should_send_summary = self._should_send_daily_summary(current_rate, threshold)
                ...
                if should_send_summary:
                    ...
                    # Send daily summary
                    summary_sent = self._send_email_notification(rate_data, is_alert=False)
    ...
    def _should_send_daily_summary(self, current_rate: float, threshold: float) -> bool:
        ...
        return (self.last_daily_summary != today and 
                current_rate >= threshold and
                self._is_time_for_daily_summary())
    ...
    def _send_email_notification(self, rate_data: Dict[str, Any], is_alert: bool = True) -> bool:
